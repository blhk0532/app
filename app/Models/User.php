...
use AdultDate\FilamentDialer\Models\PhoneQueue;
 ...
 * @property CarbonImmutable|null $active_at
 * @property int|null $current_team_id
 * @property CarbonImmutable|null $created_at
 * @property CarbonImmutable|null $updated_at
 * @property array<array-key, mixed>|null $ui_preferences
 * @property string|null $notes
 * @property-read \Illuminate\Database\Eloquent\Collection<int, Schedule> $activeSchedules
 * @property-read int|null $active_schedules_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, Activity> $activities
 * @property-read int|null $activities_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, Schedule> $appointmentSchedules
 * @property-read int|null $appointment_schedules_count
 * @property-read User|null $assignedTo
 * @property-read User|null $author
 * @property-read \Illuminate\Database\Eloquent\Collection<int, Schedule> $availabilitySchedules
 * @property-read int|null $availability_schedules_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, Schedule> $blockedSchedules
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection<int, PhoneQueue> $phone_queues
 * @property-read int|null $phone_queues_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, Schedule> $recurringSchedules
 * @property-read int|null $recurring_schedules_count
 * @property-read \Illuminate\Database\Eloquent\Collection<int, RingaData> $ringaData
...
class User extends Model implements AuthenticatableContract, AuthorizableContract, CanResetPasswordContract, FilamentUser, HasAvatar, HasDefaultTenant, HasTenants, MustVerifyEmailContract, WirechatUser
{
    ...
    {
        return $this->hasMany(PhoneQueue::class);
    }
    ...
    {
        return $this->morphMany(Client::class, 'owner');  // Change from hasMany to morphMany with 'owner' as the morph name
    }
