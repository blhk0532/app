...
class MultiCalendar1 extends Widget implements HasActions, HasCalendar, HasSchemas
{
    ...
    protected string $filterKey = 'booking_calendars_1';
    ...
    {
        $this->selectedTechnician1 = $this->pageFilters['booking_calendars_1'] ?? 'all';
        $this->refreshRecords();
    }
