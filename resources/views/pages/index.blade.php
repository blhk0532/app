    ...
    <div class="relative flex flex-col items-center justify-center w-full h-auto overflow-hidden" x-cloak>
        ...
        <div class="flex items-center w-full max-w-6xl px-8 pt-12 pb-20 mx-auto">
            <div class="container relative max-w-4xl mx-auto mt-20 text-center sm:mt-24 lg:mt-32">
                ...
                Begin Your Journey<br> With Mentor Ai </h1>
                <p class="w-full max-w-2xl mx-auto mt-8 text-lg dark:text-white/60 text-slate-500">Not just a chatbot it’s a structured business assistant
built to drive real business outcomes and helps companies grow revenue through practical improvements </p>
                <div class="flex items-center justify-center w-full px-20 mx-auto mt-8 space-x-5">
                   
                    <x-ui.button type="primary" tag="a" href="https://github.com/blhk0532/mentor" target="_blank">View on Wix.com</x-ui.button>
                    <x-ui.button type="secondary" tag="a" href="https://github.com/blhk0532/mentor" target="_blank">View the Docs</x-ui.button>
                </div>
            </div>
        </div>
