...
new class extends Component
{
    ...
    {
        $this->powerupsJSON = json_decode(file_get_contents(public_path('/mentor/power-ups.json')));
    ...
    public function install($repo, $index)
    {
        ...
        $filePath = public_path('/mentor/power-ups.json');
        ...
        return redirect()->to('/mentor/power-ups');
    }
};

name('mentor.power-ups');

?>

<x-layouts.marketing>

    @volt('mentor-powerups')
    <div class="w-full ">
        ...
        <div class="w-full max-w-6xl px-8 mx-auto">
            ...
            <div class="relative w-full p-6 pl-12 text-yellow-700 border border-yellow-200 rounded-lg dark:border-transparent dark:bg-yellow-500 dark:text-white bg-yellow-50">
                ...
                <div class="text-sm opacity-80 dark:opacity-100">Before deploying and using the application in production you will want to complete
                    the setup and configuration process. The demo widget is limited for testing</div>
            </div>
