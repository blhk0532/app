...
import { useFullCalendarController } from '@/hooks/use-fullcalendar-controller'
...
export function ResourceTimeline({
  ...
  const { calendarRef, controller, handleDatesSet } = useFullCalendarController(availableViews)
  ...
  return (
    ...
    >
      ...
      <SchedulerViews
        ...
        datesSet={(arg) => handleDatesSet(arg, restOptions.datesSet)}
        popoverCloseContent={() => (
