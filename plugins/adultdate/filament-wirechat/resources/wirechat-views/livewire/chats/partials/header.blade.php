...
<style>
    ...
    @if ($chatsSearch)
        <section class="mt-4">
            <div style="margin-top: -66px; margin-right: 66px;  margin-left: 12px;" class="px-2 py-3 rounded-lg dark:bg-[var(--wc-dark-secondary)]  bg-[var(--wc-light-secondary)]  grid grid-cols-12 items-center">
