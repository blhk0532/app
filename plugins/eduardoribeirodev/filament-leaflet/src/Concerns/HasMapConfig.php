...
trait HasMapConfig
{
     ...
     */
    final protected function getZoomOptions(): array
    {
        return [
            'max' => $this->maxZoom,
            'min' => $this->minZoom,
     ...
     */
    final protected function getMapOptions(): array
    {
        return [
     ...
     */
    final protected function getMapControls(): array
    {
        return [
     ...
     */
    final protected function getDrawControls(): array
    {
     ...
     */
    final public function handleLayerUpdated(string $layerId, array $data): void
    {
     ...
     */
    final public function getMapData(): array
    {
        return [
            'mapId' => $this->getId(),
