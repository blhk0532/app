...
class MetadataCacheTest extends TestCase
{
    ...
    public function test_listing_is_cached(): void
    {
        ...
        $this->assertTrue(Cache::has('fm:public::name:asc'));
    }
    ...
    public function test_cache_key_includes_sort_parameters(): void
    {
        ...
        $this->assertTrue(Cache::has('fm:public::name:asc'));
        $this->assertFalse(Cache::has('fm:public::size:desc'));
        ...
        $this->assertTrue(Cache::has('fm:public::size:desc'));
    }
    ...
    public function test_cache_key_includes_path(): void
    {
        ...
        $this->assertTrue(Cache::has('fm:public:subdir:name:asc'));
        $this->assertFalse(Cache::has('fm:public::name:asc'));
    }
    ...
    public function test_move_invalidates_both_source_and_destination_cache(): void
    {
        ...
        $this->assertTrue(Cache::has('fm:public::name:asc'));
        $this->assertTrue(Cache::has('fm:public:target:name:asc'));

        $this->service->move('public', 'file.txt', 'target');

        $this->assertFalse(Cache::has('fm:public::name:asc'));
        $this->assertFalse(Cache::has('fm:public:target:name:asc'));
    }
    ...
    public function test_invalidation_clears_all_sort_combinations(): void
    {
        ...
        $this->assertTrue(Cache::has('fm:public::name:asc'));
        $this->assertTrue(Cache::has('fm:public::size:asc'));
        $this->assertTrue(Cache::has('fm:public::date:asc'));

        $this->service->delete('public', 'file.txt');

        $this->assertFalse(Cache::has('fm:public::name:asc'));
        $this->assertFalse(Cache::has('fm:public::size:asc'));
        $this->assertFalse(Cache::has('fm:public::date:asc'));
    }
}
