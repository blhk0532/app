...
import { closeSwedenPersonPool, syncSwedenPersonFromHitta } from './sweden_personer_sync.mjs';
  ...
  async saveHittaToDatabase(hittaData) {
    ...
    try {
      ...
      try {
        ...
        console.log(`  ⚠ sweden_personer sync failed for ${hittaData.personnamn}:`, syncError.message);
      }
